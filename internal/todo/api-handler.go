...
type APITodoHandler struct {
	service Service
}

func NewAPITodoHandler(service Service) APIHandler {
	return &APITodoHandler{
		service: service,
	}
}

func (th *APITodoHandler) GetAll(w http.ResponseWriter, r *http.Request) {
...
func (th *APITodoHandler) Create(w http.ResponseWriter, r *http.Request) {
	err := r.ParseForm()
...
func (th *APITodoHandler) Delete(w http.ResponseWriter, r *http.Request) {
	err := r.ParseForm()
...
func (th *APITodoHandler) Put(w http.ResponseWriter, r *http.Request) {
	err := r.ParseForm()
...
func (th *APITodoHandler) renderList(w http.ResponseWriter, r *http.Request) {
